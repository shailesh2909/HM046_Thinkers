        ...
        <div className="w-full max-w-md">
          <div className="p-12 bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="mb-8">
              ...
              <p className="text-gray-600">Join us as a freelancer or business</p>
            </div>
            ...
            <div className="mt-6 flex justify-center gap-3">
              <button className="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-lg hover:bg-gray-100 transition" title="Sign up with GitHub">
              ...
              <button className="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-lg hover:bg-gray-100 transition" title="Sign up with Google">
              ...
              <button className="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-lg hover:bg-gray-100 transition" title="Sign up with LinkedIn">
                <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <a href="/signin" className="text-indigo-600 font-semibold hover:text-indigo-700 transition">
                  Sign In
                </a>
              </p>
            </div>
