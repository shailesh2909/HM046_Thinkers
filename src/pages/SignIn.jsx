          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="relative bg-gradient-to-br from-teal-600 via-teal-500 to-teal-400 p-12 flex flex-col justify-center items-center text-white overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg mb-8 text-white/90">Enter your personal details and start journey with us</p>
                <a
                  href="/signup"
            ...
            <div className="p-12 flex flex-col justify-center bg-gray-50">
              <div className="mb-6">
                <h1 className="text-4xl font-bold text-teal-600 mb-1">Lelo</h1>
                <h2 className="text-3xl font-bold text-gray-800">Sign in to Lelo</h2>
              </div>
              ...
              <form onSubmit={handleSignInSubmit} className="space-y-4">
                ...
                <div className="text-right">
                  <a href="#" className="text-sm text-gray-600 hover:text-teal-600 font-medium">
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600">
                  ...
                  <a href="/signup" className="text-teal-600 font-semibold hover:text-teal-700 transition">
                    Sign Up
                  </a>
                </p>
              </div>
